    ...
    SELECT 
        ...
        CAST(
            IFNULL(
                CAST(
                    CONCAT(
                        CAST(EXTRACT(YEAR FROM PARSE_DATE('%Y-%m-%d', Period.PERIOD_DT_ID)) AS STRING),
                        LPAD(CAST(EXTRACT(MONTH FROM PARSE_DATE('%Y-%m-%d', Period.PERIOD_DT_ID)) AS STRING), 2, '0'),
        ...
        CAST(CC.SEGMENT1 AS STRING) AS SEGMENT1,
        CAST(CC.SEGMENT2 AS STRING) AS SEGMENT2,
        CAST(CC.SEGMENT3 AS STRING) AS SEGMENT3,
        CC.SEGMENT4 AS SEGMENT4,
        CAST(CC.SEGMENT5 AS STRING) AS SEGMENT5,
